// Reused from the user's chennai-gta renderer; excludes already-lit capture geometry.
  ...
  _renderOverride(
    ...
    try {
      ...
      this.scene.traverse((object) => {
        ...
        if(object.userData.excludeFromAO && object.visible){hidden.push(object);object.visible=false;return;}
